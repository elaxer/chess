...
// It allows for the creation of pieces based on their notation (like "P" for Pawn, "R" for Rook, etc.)
...
type PieceFactory interface {
	...
	// The notation string should be one of the predefined notations (e.g., "P" for Pawn, "R" for Rook).
