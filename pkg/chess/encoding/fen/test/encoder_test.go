...
func TestEncoder_Encode(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"empty",
			args{chesstest.MustDecodeFEN8x8("8/8/8/8/8/8/8/8")},
			"8/8/8/8/8/8/8/8 w",
		},
		{
			"white",
			args{chesstest.MustDecodeFEN8x8("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w")},
			"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w",
		},
		{
			"black",
			args{chesstest.MustDecodeFEN8x8("3b2n1/pp2p1p1/2k2r2/3P4/8/2N1B1q1/3P4/R3K3 b")},
			"3b2n1/pp2p1p1/2k2r2/3P4/8/2N1B1q1/3P4/R3K3 b",
		},
		{
			"valid",
			args{chesstest.MustDecodeFEN8x8("3r2k1/pRp4p/2R3p1/8/3K4/P4r2/2P4P/1N6")},
			"3r2k1/pRp4p/2R3p1/8/3K4/P4r2/2P4P/1N6 w",
		},
		{
			"6x6",
			args{chesstest.MustDecodeFEN("rnq1kb/pp1ppp/6/6/PPP1PP/RNQK1B", position.FromString("f6"))},
			"rnq1kb/pp1ppp/6/6/PPP1PP/RNQK1B w",
		},
		{
			"12x8",
			args{chesstest.MustDecodeFEN("2r1k2bnq1p/3p4p1P1/2n3B1P3/1P1b2N3p1/2Q1P1p3R1/3K3P2N1/1p2B2P2p1/12", position.FromString("l8"))},
			"2r1k2bnq1p/3p4p1P1/2n3B1P3/1P1b2N3p1/2Q1P1p3R1/3K3P2N1/1p2B2P2p1/12 w",
		},
		{
			"7x13",
			args{chesstest.MustDecodeFEN(
...
func TestEncoder_EncodeWithMetricFuncs(t *testing.T) {
	board := chesstest.MustDecodeFEN8x8("3b2n1/pp2p1p1/2k2r2/3P4/8/2N1B1q1/3P4/R3K3 b")
