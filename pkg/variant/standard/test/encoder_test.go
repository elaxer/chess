...
func TestEncodeFEN(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := standard.EncodeFEN(tt.args.board); got != tt.want {
				t.Errorf("EncodeFEN() = \n%v want\n%v", got, tt.want)
			}
		})
	}
...
func TestEncodePGN(t *testing.T) {
	...
	pgn := standard.EncodePGN(board, map[string]string{
