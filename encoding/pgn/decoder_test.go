...
1-0`},
			...
			chesstest.MoveStrings(
				"d4", "d5", "c4", "e6", "Nf3", "Nf6", "g3", "Be7", "Bg2", "O-O", "O-O", "dxc4", "Nc3", "a6", "Ne5",
				"Ra7", "Nxc4", "b5", "Ne5", "Bb7", "Bxb7", "Rxb7", "Be3", "Nd5", "Nxd5", "Qxd5", "Qb3", "Rd8",
				"Rfc1", "c5", "dxc5", "Qxe5", "c6", "Nxc6", "Rxc6", "a5", "Rd1", "Rxd1", "Qxd1", "h6",
				"Rc8", "Kh7", "Qc2", "Qf5", "Qc6", "Qd5", "Qxd5", "exd5", "Bd4", "Kg6", "Kg2", "f6", "Kf3",
				"Kf5", "Rc6", "a4", "g4", "Kg6", "h4", "Kf7", "h5", "b4", "Bc5", "a3", "b3", "Bxc5", "Rxc5",
				"Ke6", "Ke3", "Kd6", "Kd4", "Ke6", "f4", "f5", "Rc6", "Kd7", "Rg6", "fxg4", "Rxg7", "Kc6",
				"Rxg4", "Re7", "e3", "Re4", "Kd3", "Kc5", "Rg6", "Re8", "Rxh6", "Rg8", "Rg6", "Rh8", "h6",
			),
...
h6 60. Nd7 h5 61. Ne5 h4 62. Nf3# 1-0`},
			...
			chesstest.MoveStrings(
				"d4", "Nf6", "Nf3", "e6", "g3", "b5", "Bg2", "Bb7", "O-O", "c5", "Bg5", "Qb6", "a4", "a6", "Nc3", "Ne4",
				"Nxe4", "Bxe4", "axb5", "Qxb5", "Qd2", "f6", "Bf4", "Qb7", "c4", "cxd4", "Qxd4", "e5",
				"Bxe5", "fxe5", "Qxe5", "Be7", "Nd4", "Bxg2", "Nf5", "Qb4", "Kxg2", "Nc6", "Qxg7", "O-O-O",
				"Rxa6", "Qb7", "Rfa1", "Nb4", "Kg1", "Nxa6", "Qxe7", "Qb6", "Qa3", "Rhf8", "Nd6", "Kc7",
				"Qxa6", "Ra8", "Qxb6", "Kxb6", "Rd1", "Ra2", "Rd2", "Kc6", "f3", "Rfa8", "Nb5", "R8a4", "Rc2",
				"Kc5", "Nc3", "Ra1", "Kf2", "Rxc4", "Rd2", "Ra7", "e4", "Kc6", "Ke3", "Rb7", "Rc2", "d6",
				"Kd3", "Rb5", "f4", "Rbb4", "g4", "Kd7", "g5", "Ke6", "h4", "d5", "Nxd5", "Rxc2", "Nxb4", "Rxb2",
				"Nc2", "Rb3", "Kc4", "Rh3", "Nd4", "Kf7", "f5", "Rxh4", "Kd5", "Rg4", "Nf3", "Rg3",
				"Ne5", "Kg8", "f6", "Rxg5", "Ke6", "Rg1", "f7", "Kg7", "Nd7", "Rf1", "f8=Q", "Rxf8", "Nxf8",
				"h6", "Nd7", "h5", "Ne5", "h4", "Nf3",
			),
			false,
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			decoder := &Decoder{tt.fields.headersRegexp, tt.fields.movesRegexp}
			gotHeaders, gotMoves, err := decoder.Decode(tt.args.pgn)
